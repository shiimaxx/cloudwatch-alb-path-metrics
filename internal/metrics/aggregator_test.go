...
func TestMetricAggregator_GetCloudWatchMetricData(t *testing.T) {
	...
	assert.Equal(t, route, *md0.Dimensions[2].Value)
	...
	assert.Equal(t, route, *md1.Dimensions[2].Value)
	...
	assert.Equal(t, route, *md2.Dimensions[2].Value)
	...
	assert.Equal(t, route, *md3.Dimensions[2].Value)
	...
	assert.Equal(t, route, *md4.Dimensions[2].Value)
	...
	assert.Equal(t, route, *md5.Dimensions[2].Value)
